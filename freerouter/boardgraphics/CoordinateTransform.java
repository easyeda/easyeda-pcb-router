...
public class CoordinateTransform implements java.io.Serializable {
	...
	public CoordinateTransform(CoordinateTransform p_coordinate_transform) {
		...
		this.rotation_pole = new FloatPoint(p_coordinate_transform.rotation_pole.x,
				p_coordinate_transform.rotation_pole.y);
		this.design_box_with_offset = new IntBox(p_coordinate_transform.design_box_with_offset.ll,
	...
	public java.awt.Rectangle board_to_screen(IntBox p_box) {
		...
		java.awt.Rectangle result = new java.awt.Rectangle((int) Math.floor(ll_x), (int) Math.floor(ll_y),
	...
	public IntBox screen_to_board(java.awt.Rectangle p_rect) {
		...
		FloatPoint corner_2 = screen_to_board(
				new Point2D.Double(p_rect.getX() + p_rect.getWidth(), p_rect.getY() + p_rect.getHeight()));
	...
	public void set_mirror_top_bottom(boolean p_value) {
		// Because the origin of display is the upper left corner, the internal
		// value
