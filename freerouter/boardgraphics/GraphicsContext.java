...
public class GraphicsContext implements java.io.Serializable {
	public GraphicsContext(IntBox p_design_bounds, Dimension p_panel_bounds, board.LayerStructure p_layer_structure,
	 ...
	 */
	public void draw(FloatPoint[] p_points, double p_half_width, Color p_color, Graphics p_g,
	 ...
	 */
	public void draw_circle(FloatPoint p_center, double p_radius, double p_draw_half_width, Color p_color, Graphics p_g,
			double p_translucency_factor) {
		if (p_color == null) {
			return;
		}
	 ...
	 * draws a rectangle
	 */
	public void draw_rectangle(FloatPoint p_corner1, FloatPoint p_corner2, double p_draw_half_width, Color p_color,
			Graphics p_g, double p_translucency_factor) {
		if (p_color == null) {
			return;
		}
		Graphics2D g2 = (Graphics2D) p_g;
	 ...
	 */
	public void draw_boundary(Shape p_shape, double p_draw_half_width, Color p_color, Graphics p_g,
			double p_translucency_factor) {
		if (p_shape instanceof PolylineShape) {
			...
			this.draw_circle(curr_circle.center.to_float(), curr_circle.radius, p_draw_half_width, p_color, p_g,
	 ...
	 */
	public void draw_boundary(Area p_area, double p_draw_half_width, Color p_color, Graphics p_g,
			double p_translucency_factor) {
	...
	public void fill_ellipse_arr(Ellipse[] p_ellipse_arr, Graphics p_g, Color p_color, double p_translucency_factor) {
		...
		for (Ellipse curr_ellipse : p_ellipse_arr) {
			...
			Ellipse2D draw_ellipse = new Ellipse2D.Double(center.getX() - bigger_radius, center.getY() - smaller_radius,
	 ...
	 * (line)
	 */
	private boolean line_outside_update_box(FloatPoint p_1, FloatPoint p_2, double p_update_offset,
			IntBox p_update_box) {
