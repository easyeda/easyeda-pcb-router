...
public class AutorouteSettings implements java.io.Serializable {
	...
	public static int maxRouteRetry = 4;
	...
	public AutorouteSettings(RoutingBoard p_board) {
		...
		// additional costs aagainst preferred direcction with 1 digit behind
		// the decimal point.
	...
	public AutorouteSettings(AutorouteSettings p_settings) {
		...
		System.arraycopy(p_settings.preferred_direction_is_horizontal_arr, 0,
				this.preferred_direction_is_horizontal_arr, 0, preferred_direction_is_horizontal_arr.length);
		...
		System.arraycopy(p_settings.against_preferred_direction_trace_cost_arr, 0,
				against_preferred_direction_trace_cost_arr, 0, against_preferred_direction_trace_cost_arr.length);
	}
