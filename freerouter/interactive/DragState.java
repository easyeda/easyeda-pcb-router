...
public abstract class DragState extends InteractiveState {
	...
	public static DragState get_instance(FloatPoint p_location, InteractiveState p_parent_state,
		...
		for (int i = 0; i < try_count; ++i) {
			if (i == 0 || pick_layer != curr_layer
				...
				java.util.Collection<Item> found_items = p_board_handling.get_routing_board()
	...
	protected DragState(FloatPoint p_location, InteractiveState p_parent_state, BoardHandling p_board_handling,
			Logfile p_logfile) {
