...
public class SelectItemsInRegionState extends SelectRegionState {
	 ...
	 */
	public static SelectItemsInRegionState get_instance(InteractiveState p_parent_state, BoardHandling p_board_handling,
			Logfile p_logfile) {
	...
	private SelectItemsInRegionState(InteractiveState p_parent_state, BoardHandling p_board_handling,
			Logfile p_logfile) {
	...
	private void select_all_in_region() {
		...
		Set<Item> found_items = hdlg.settings.item_selection_filter
