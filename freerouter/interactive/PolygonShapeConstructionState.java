	...
	public InteractiveState complete() {
		...
		if (construction_succeeded) {
			...
			if (obstacle_shape.split_to_convex() == null) {
				...
				construction_succeeded = hdlg.get_routing_board().check_shape(obstacle_shape, hdlg.settings.layer,
						new int[0], cl_class);
			}
			if (construction_succeeded) {
				...
				hdlg.get_routing_board().insert_obstacle(obstacle_shape, hdlg.settings.layer, cl_class,
						board.FixedState.UNFIXED);
