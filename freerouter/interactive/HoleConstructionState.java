...
public class HoleConstructionState extends CornerItemConstructionState {
	...
	private boolean start_ok(FloatPoint p_location) {
		...
		ItemSelectionFilter.SelectableChoices[] selectable_choices = { ItemSelectionFilter.SelectableChoices.KEEPOUT,
				ItemSelectionFilter.SelectableChoices.VIA_KEEPOUT, ItemSelectionFilter.SelectableChoices.CONDUCTION };
