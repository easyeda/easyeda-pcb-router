...
public class Communication implements java.io.Serializable {
	...
	public Communication(Unit p_unit, int p_resolution, SpecctraParserInfo p_specctra_parser_info,
			CoordinateTransform p_coordinate_transform, IdNoGenerator p_id_no_generator, BoardObservers p_observers) {
	...
	public Communication() {
		this(Unit.MIL, 1, new SpecctraParserInfo("\"", null, null, null, null, false), new CoordinateTransform(1, 0, 0),
				new board.ItemIdNoGenerator(), new BoardObserverAdaptor());
	}
	...
	public static class SpecctraParserInfo implements java.io.Serializable {
		public SpecctraParserInfo(String p_string_quote, String p_host_cad, String p_host_version,
				java.util.Collection<String[]> p_constants, WriteResolution p_write_resolution,
