...
public class IntVector extends Vector implements java.io.Serializable {
	 ...
	 * Side.ON_THE_LEFT, if this Vector is on the left of L Side.ON_THE_RIGHT, if
	 * this Vector is on the right of L and Side.COLLINEAR, if this Vector is
	 * collinear with L.
	 */
	@Override
	...
	/**
	 * The function returns Signum.POSITIVE, if the scalar product of this vector
	 * and p_other > 0, Signum.NEGATIVE, if the scalar product Vector is < 0, and
