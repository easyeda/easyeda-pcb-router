...
public class Line implements Comparable<Line>, java.io.Serializable {
	...
	/**
	 * Returns true, if this and p_other define the same line. Is designed for good
	 * performance, but works only for lines consisting of IntPoints.
	 */
	 ...
	 * Otherwise Side.ON_THE_LEFT, if this line is on the left of p_point, or
	 ...
	 * Side.ON_THE_RIGHT, if this line is on the right of p_point, Side.COLLINEAR
	 * otherwise.
	 */
	...
	/**
	 * Returns Side.ON_THE_LEFT, if this line is on the left of the intersection of
	 * p_1 and p_2, Side.ON_THE_RIGHT, if this line is on the right of the
	 * intersection, and Side.COLLINEAR, if all 3 lines intersect in exacly 1 point.
	 */
	 ...
	 * If the lines are parallel the result coordinates will be Integer.MAX_VALUE.
	 * Useful in situations ehere performance is more important than accuracy.
	 */
	...
	/**
	 * translates the line perpendicular at about p_dist. If p_dist > 0, the line
	 * will be translated to the left, else to the right
	 */
	 ...
	 * bigger than the direction of l_2. Implements the comparable interface. Throws
	 * a cast exception, if p_other is not a Line. Fast implementation only for
	 * lines consisting of IntPoints because of critical performance
	 */
	@Override
	...
	/**
	 * Calculates an approximation of the function value of this line at p_x, if the
	...
	/**
	 * Calculates the direction from p_from_point to the nearest point on this line
	 * to p_fro_point. Returns null, if p_from_point is contained in this line.
	 */
	public Direction perpendicular_direction(Point p_from_point) {
		...
		Direction result;
		if (nearest_line_point.distance_square(check_point_1.to_float()) <= nearest_line_point
				.distance_square(check_point_2.to_float())) {
			result = dir1;
		} else {
			result = dir2;
		}
	...
	transient private Direction dir; // should only be accessed from
										// get_direction().
}