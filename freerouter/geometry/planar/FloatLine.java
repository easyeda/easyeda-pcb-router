...
public class FloatLine {
	...
	/**
	 * Calculates the intersection of this line with p_other. Returns null, if the
	 * lines are parallel.
	 */
	...
	/**
	 * Returns an approximation of the perpensicular projection of p_point onto this
	 * line.
	 */
	...
	/**
	 * Returns the projection of p_line_segment onto this oriented line segment by
	 * moving p_line_segment perpendicular into the direction of this line segmant
	 * Returns null, if the projection is empty or p_line_segment.a ==
	 * p_line_segment.b
	 */
	public FloatLine segment_projection_2(FloatLine p_line_segment) {
		...
		if (p_line_segment.a.scalar_product(p_line_segment.b, this.a) < 0) {
			FloatLine curr_perpendicular_line = new FloatLine(p_line_segment.a,
					p_line_segment.b.turn_90_degree(1, p_line_segment.a));
			projected_a = curr_perpendicular_line.intersection(this);
			if (projected_a == null || Math.abs(projected_a.x) >= Limits.CRIT_INT
		...
		if (p_line_segment.b.scalar_product(p_line_segment.a, this.b) < 0) {
			FloatLine curr_perpendicular_line = new FloatLine(p_line_segment.b,
					p_line_segment.a.turn_90_degree(1, p_line_segment.b));
	...
	/**
	 * Shrinks this line on both sides by p_value. The result will contain at least
	 * the gravity point of the line.
	 */
	...
	/**
	 * Calculates the nearest point on this line to p_from_point between this.a and
	 * this.b.
	 */
	...
	public String toString() {
		...
		return "start FloatPoint :" + a + ",end FloatPoint:" + b;
	}
