...
public class IntDirection extends Direction implements java.io.Serializable {
	 ...
	 * strict bigger angle with the positive x-axis than p_other_direction, 0, if
	 * this direction is equal to p_other_direction, and -1 otherwise. Throws an
	 * exception, if p_other_direction is not a Direction.
	 */
	@Override
