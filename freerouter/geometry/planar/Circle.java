...
public class Circle implements ConvexShape, java.io.Serializable {
	...
	public TileShape bounding_tile() {
		...
		// the following caused problems with the spring_over algorithm in
		// routing.
		/*
		 * if (this.precalculated_bounding_tile == null) {
		 * this.precalculated_bounding_tile =
		 * bounding_tile(c_max_approximation_segment_length); } return
		 * this.precalculated_bounding_tile;
		 */
	}
