...
public class Plane extends ScopeKeyword {
	...
	public boolean read_scope(ReadScopeParameter p_par) {
		...
		// Cadence Allegro cutouts the pins on power planes, which leads to
	...
	public static void write_scope(WriteScopeParameter p_par, board.ConductionArea p_conduction)
