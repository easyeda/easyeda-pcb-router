...
public class ReadScopeParameter {
	...
	ReadScopeParameter(Scanner p_scanner, interactive.BoardHandling p_board_handling, board.BoardObservers p_observers,
	...
	public HashMap<String, Boolean> position_fixed = new HashMap<>();
	...
	/**
	 * The names of the via padstacks filled while reading the structure scope and
	 * evaluated after reading the library scope.
	 */
	...
	java.util.Collection<PartLibrary.LogicalPartMapping> logical_part_mappings = new java.util.LinkedList<PartLibrary.LogicalPartMapping>();
