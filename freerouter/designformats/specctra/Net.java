...
public class Net {
	...
	public static void write_scope(WriteScopeParameter p_par, rules.Net p_net, Collection<board.Pin> p_pin_list)
	...
	public static void write_net_id(rules.Net p_net, IndentFileWriter p_file, IdentifierType p_identifier_type)
			throws java.io.IOException {
		p_file.write("net ");
