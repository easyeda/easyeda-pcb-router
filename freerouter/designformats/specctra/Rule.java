...
public abstract class Rule {
	...
	private static void write_layer_rule(rules.NetClass p_net_class, int p_layer_no, WriteScopeParameter p_par)
	...
	public static void write_default_rule(WriteScopeParameter p_par, int p_layer) throws java.io.IOException {
		...
		p_par.file.write("rule");
		// write the trace width
		double trace_width = 2 * p_par.coordinate_transform
				.board_to_dsn(p_par.board.rules.get_default_net_class().get_trace_half_width(0));
		p_par.file.new_line();
		p_par.file.write("(width ");
		p_par.file.write((new Double(trace_width)).toString());
		p_par.file.write(")");
		...
		Double smd_to_turn_dist = p_par.coordinate_transform
				.board_to_dsn(p_par.board.rules.get_pin_edge_to_turn_dist());
		p_par.file.new_line();
		p_par.file.write("(clear ");
	 ...
	 * clearance.
	 */
	private static void write_clearance_rules(WriteScopeParameter p_par, int p_layer, int p_cl_class,
			int p_max_cl_class, int p_default_clearance) throws java.io.IOException {
