...
public class TargetItemExpansionDoor implements ExpandableObject {
	...
	public TargetItemExpansionDoor(Item p_item, int p_tree_entry_no, CompleteExpansionRoom p_room,
	...
	public String toString() {
		String string = "item :" + item + "\n" + "tree_entry_no :" + tree_entry_no + "\n" + "room :" + room + "\n"
				+ "shape :" + shape + "\n" + "maze_search_info" + maze_search_info;
		return string;
	}
