...
public class Connection {
	...
	public static Connection get(Item p_item) {
		...
		for (Item curr_item : contacts) {
			...
			for (;;) {
				if (!curr_item.is_route() || fork_found || connection_items.add(curr_item)) {
					// connection ends
					if (start_point == null) {
	 ...
	 */
	private Connection(Point p_start_point, int p_start_layer, Point p_end_point, int p_end_layer,
