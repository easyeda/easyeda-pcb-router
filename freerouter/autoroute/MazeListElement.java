...
public class MazeListElement implements Comparable<MazeListElement> {
	...
	public int compareTo(MazeListElement p_other) {
		...
		// make shure, that the result cannot be 0, so that no element in the
		// set is
	...
	public String toString() {
		String string = "door shape:" + door.get_shape() + "\n" + "section_no_of_door:" + section_no_of_door + "\n"
				+ "section_no_of_backtrack_door:" + section_no_of_backtrack_door + "\n" + "next_room:"
				+ next_room.get_target_doors() + "\n" + "shape_entry:" + shape_entry + "\n";
		return string;
	}
